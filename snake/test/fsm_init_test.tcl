...
set arquivos {"src/snake_package.vhd" "src/fsm_init.vhd" "src/clock.vhd" "test/fsm_init_stimuli.vhd" "test/fsm_init_tb.vhd"}

set componente "fsm_init_tb"

set duration [expr {240}]
